...
CREATE TABLE `category_user`  (
  ...
  `category_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '名称',
  `category_icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图标',
  `category_type` tinyint NULL DEFAULT NULL COMMENT '1收入 2支出',
  `sort` int NULL DEFAULT 0 COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_user_id_category_type_sort`(`user_id` ASC, `category_type` ASC, `sort` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户分类' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (10001, 'admin', '超级管理员', '', '', '超级管理员', '$2a$10$749K7cnqCXTKDRqeINEuOefopTM7gi5TJjid/PmZC5i6ZHSxGrBEW', 0, '', '', '', 0, '', 1, NULL, '2025-12-08 15:44:05', '2025-12-08 15:44:05', NULL, NULL);

...
一个基于 Spring Boot3 的家庭记账微信小程序，支持账单记录、预算管理、AI 智能助手、家庭共享等功能。
...
- **后端代码**: 当前仓库
- **微信小程序**: [https://gitee.com/zhang-lichao/billing_mini.git](https://gitee.com/zhang-lichao/billing_mini.git)
...
<table>
  <tr>
    <td align="center">
      <img src="src/main/resources/images/AI助手页面.png" width="200" alt="AI助手页面"/>
      <br/>AI助手页面
    </td>
    <td align="center">
      <img src="src/main/resources/images/分类页面.png" width="200" alt="分类页面"/>
      <br/>分类页面
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="src/main/resources/images/发现页面.png" width="200" alt="发现页面"/>
      <br/>发现页面
    </td>
    <td align="center">
      <img src="src/main/resources/images/图标分析页面.png" width="200" alt="图标分析页面"/>
      <br/>图标分析页面
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="src/main/resources/images/我的页面.png" width="200" alt="我的页面"/>
      <br/>我的页面
    </td>
    <td align="center">
      <img src="src/main/resources/images/记账页面.png" width="200" alt="记账页面"/>
      <br/>记账页面
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="src/main/resources/images/账单页面.png" width="200" alt="账单页面"/>
      <br/>账单页面
    </td>
    <td align="center">
      <img src="src/main/resources/images/贷款计算页面.png" width="200" alt="贷款计算页面"/>
      <br/>贷款计算页面
    </td>
  </tr>
</table>
